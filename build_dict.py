...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--train", help="File prefix to save train data", required=False)
    ...
    if args.train:
        ...
        train_samples = 0
        with open(args.train + ".center", "wb+") as center_fd:
            with open(args.train + ".context", "wb+") as context_fd:
                for sentence in iterate_input_sentences(args.input):
                    ...
                    for center_ofs, center_word in enumerate(sentence):
                        ...
                        for context_word in sentence[left:right+1]:
                            ...
                            center_fd.write(center_dat)
                            context_fd.write(context_dat)
                            train_samples += 1
